...
class smallBullet:baseclass{
	...
	public:
	smallBullet(SDL_Surface *img,int x,int y,int xvel,int yvel,int d);//No incluimos destructor porque liberamos image cada vez que la usamos// 
