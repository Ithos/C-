...
void display(){
	...
	glPushMatrix();//Guardamos la matriz que tengamos, en este caso la identidad
		glTranslatef(-2.0,0.0,-10.0);//Cada vez que lo llamemos multiplica la matriz actual por una de traslacion que indiquemos moviendo cosas en uno o varios ejes
	...
	glPushMatrix();
		glTranslatef(2.0,0.0,-10.0);//Esto es un ejemplo para que se vea como dos objetos giran en distintas direcciones
