...
void init(){
    ...
    mainShader=new shader("vertex6_2.vs","fragment6_2.frag");
    quadRenderShader=new shader("vertex7.vs","fragment7.frag");
...
void display(){
	...
	//updateCamera(); movemos las funciones de la camara para que solo rote la textura o algo asi
	glTranslatef(0.0,0.0,-3.0);
	glRotatef(angle,0.0,1.0,0.0);
	glUniform3f(glGetUniformLocation(mainShader->getProgramId(),"lightPos"),0,0,0);
	glUniform3f(glGetUniformLocation(mainShader->getProgramId(),"cameraPosition"),camPos().x,camPos().y,camPos().z);
