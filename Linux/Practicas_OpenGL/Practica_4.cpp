...
void init(){
	...
	glNewList(triangle,GL_COMPILE);//Creamos una lista dando identificador y modo, con este modo solo compilamos con el modo compile and execute compilamos y mandamos a la pantalla
...
void display(){
	...
	glCallList(triangle);//Las traslaciones de arriba se aplican a todas las imagenes a partir de su ejecucion //llamamos a la lista mediante su identificador
}
