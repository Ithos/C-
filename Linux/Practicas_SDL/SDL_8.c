...
int main (int argc, char** argv){
	...
	SDL_Surface* screen, *image, *text;//SDL_Surface es un struct
	...
	Uint32 color3=SDL_MapRGB(screen->format,0xaa,0x00,0xaa); //Definimos un color
	...
	text=TTF_RenderText_Solid(font,"Hello World",color4);
