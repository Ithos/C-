...
//Esta función nos permite cambiar el color de la pantalla pixel a pixel indicando direccion de la pantalla, posición y código de colores
...
int main (int argc, char** argv){
	...
	screen=SDL_SetVideoMode(640,480,32,SDL_SWSURFACE);//Cambiamos a 8bits por pixel para realizar las primeras manipulaciones
	...
	while(run){
		...
		//Probamos la función de manipulación de pixeles

		for(i=0;i<200;i++){
			pixelShaper(screen,i,i,i,i,i);
		}
